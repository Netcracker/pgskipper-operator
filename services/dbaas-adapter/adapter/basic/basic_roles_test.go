...
func TestCreateRoles(t *testing.T) {
	...
	conn.On("Exec", context.Background(), createUser(prefixedUser, user)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), allowConnectionsToDb(dbName)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), AllowReplicationForUser(prefixedUser)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantAllRightsOnDatabase(dbName, prefixedUser)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantSchemaCreate(schema, prefixedUser)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantSchemaCreate(schema, user)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantSchemaUsage(schema, prefixedUser)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setReadOnlyRoleSequencesGrants(schema, prefixedUser)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setReadWriteRoleSequencesGrants(schema, prefixedUser)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setAdminRoleSequencesGrants(schema, prefixedUser)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantConnectionToDB(dbName, prefixedUser)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), changeUserPassword(prefixedUser, user)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	...
	conn.On("Exec", context.Background(), setAdminGrants(schema, prefixedUser)).Return(pgconn.NewCommandTag("UPDATED"), nil)
...
func Test_CreateRoles_MultiUsers(t *testing.T) {
	...
	conn.On("Query", context.Background(), getSchemasQuery()).Return(rows, nil)
	conn.On("Query", context.Background(), getMetadata, "metadata").Return(rows, nil)
	conn.On("Exec", context.Background(), setSchemasDefaultGrants(user, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setReadWriteRoleDefaultGrants(user, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setReadWriteRoleGrants(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), createUser(userex, passwordex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), allowConnectionsToDb(dbName)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), alterOwnerMetaTable("")).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), AllowReplicationForUser(userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantAllRightsOnDatabase(dbName, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantSchemaCreate(schema, user)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantSchemaCreate(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setAdminGrants(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantSchemaUsage(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setReadWriteRoleSequencesGrants(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setAdminRoleSequencesGrants(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setSequencesRWDefaultGrants(user, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantConnectionToDB(dbName, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), revokeRights()).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), createSchema(schema)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), deleteMetaData).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), changeUserPassword(userex, passwordex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), createMetaTable).Return(pgconn.NewCommandTag("UPDATED"), nil)
...
func Test_CreateRoles_MultiUsersFailedCase(t *testing.T) {
	...
	conn.On("Query", context.Background(), getSchemasQuery()).Return(rows, nil)
	conn.On("Query", context.Background(), getMetadata, "metadata").Return(rows, nil)
	conn.On("Exec", context.Background(), dropUser(userex)).Return(pgconn.NewCommandTag("DELETED"), nil)
	conn.On("Exec", context.Background(), dropUser(user)).Return(pgconn.NewCommandTag("DELETED"), nil)
	conn.On("Exec", context.Background(), setSchemasDefaultGrants(user, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setReadWriteRoleDefaultGrants(user, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setReadWriteRoleGrants(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), createUser(userex, passwordex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), allowConnectionsToDb(dbName)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), allowConnectionsToDb(dbName2)).Return(pgconn.NewCommandTag("UPDATED"), expectedErrorC)
	conn.On("Exec", context.Background(), alterOwnerMetaTable("")).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), AllowReplicationForUser(userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantAllRightsOnDatabase(dbName, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantAllRightsOnDatabase(dbName2, userex)).Return(pgconn.NewCommandTag("UPDATED"), expectedErrorC)
	conn.On("Exec", context.Background(), grantSchemaCreate(schema, user)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantSchemaCreate(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), setAdminGrants(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantSchemaUsage(schema, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	...
	conn.On("Exec", context.Background(), setSequencesRWDefaultGrants(user, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantConnectionToDB(dbName, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), grantConnectionToDB(dbName2, userex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), revokeRights()).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), createSchema(schema)).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), deleteMetaData).Return(pgconn.NewCommandTag("UPDATED"), nil)
	conn.On("Exec", context.Background(), changeUserPassword(userex, passwordex)).Return(pgconn.NewCommandTag("UPDATED"), nil)
