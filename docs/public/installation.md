...
| metricCollector.alertsPackVersion                                             | string                                                                          | no        | v1       | Defines alerts install method. Anything except "v2" or no parameter install default alerts from template, if set to v2 it installs alerts from helm subchart (charts/patroni-services/charts/metricCollector) with ability to override them in subcharts values file.
